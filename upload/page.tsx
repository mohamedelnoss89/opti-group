            ...
            <AnimatePresence>
              {showLoginPrompt && (
                <LoginPrompt
                  ...
                  onDismiss={handleLoginPromptDismiss}
                />
              )}
            </AnimatePresence>
          </motion.div>
        ...
        {screen === "glasses-try-on" && selectedGlasses && (
          ...
          >
            <GlassesTryOn
              ...
              onBack={handleTryOnBack}
              onChangeGlasses={handleChangeGlasses}
            />
          </motion.div>
        )}
      </AnimatePresence>
