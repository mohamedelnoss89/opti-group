...
export const translations = {
  ar: {
    ...
    contactDescription: 'نسعد بتواصلكم معنا. أرسلوا لنا رسالتكم وسنرد عليكم في أقرب وقت.',
    ...
    contactError: 'حدث خطأ أثناء إرسال الرسالة. يرجى المحاولة مرة أخرى.',
    contactNamePlaceholder: 'أدخل اسمك',
    contactEmailPlaceholder: 'أدخل بريدك الإلكتروني',
    contactSubjectPlaceholder: 'ما موضوع رسالتك؟',
    ...
    contactEmailInvalid: 'البريد الإلكتروني غير صحيح',
    contactOrEmail: 'أو تواصل عبر البريد الإلكتروني',
    contactCopyEmail: 'نسخ البريد',
    ...
    sportsDesc: 'تطبيقات رياضية للمباريات والدوريات والملاعب',
  ...
  en: {
    ...
    contactDescription: 'We would love to hear from you. Send us your message and we will respond as soon as possible.',
    emailLabel: 'Email',
    phoneLabel: 'Phone',
    followUs: 'Follow Us',
    contactName: 'Name',
    ...
    contactSubjectPlaceholder: 'What is your message about?',
    ...
    contactOrEmail: 'Or contact via email',
    ...
    sportsDesc: 'Sports Apps for Scores, Leagues & Facilities',
